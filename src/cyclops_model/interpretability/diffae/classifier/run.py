"""Orchestrator for the DiffEx single-cell classifier PoC.
    ...
    python -m cyclops_model.interpretability.diffae.classifier.run --model B --gene HSPA5
    python -m cyclops_model.interpretability.diffae.classifier.run --model C --gene HSPA5
