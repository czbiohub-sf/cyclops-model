...
Usage::
    ...
    python -m cyclops_model.post_process.combination.titration.titration \
...
from cyclops_utils.analysis.map_scores import phenotypic_activity_assesment
...
def titrate_single_reporter(
    ...
    from cyclops_utils.data.feature_discovery import sanitize_signal_filename
