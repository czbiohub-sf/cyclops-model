...
from cyclops_utils.data.feature_discovery import (
    find_cell_h5ad_path,
...
def pca_sweep_pooled_signal(
    ...
    for exp, ch in exp_channel_pairs:
        ...
        if apply_iss_sidecar:
            ...
            # cyclops_model.data.iss_drift_fix for how the sidecars are built.
            from cyclops_model.features.anndata_utils import load_features_corrected
