...
the per-signal h5ads to pool into it::
    ...
    python -m cyclops_model.post_process.combination.pca_optimization \
        -o <output_root> \
...
from cyclops_model.features.anndata_utils import (
    aggregate_to_level,
    hconcat_by_perturbation,
    normalize_guide_adata,
    split_ntc_for_embedding,
)
from cyclops_utils.analysis.embedding_plots import (
    build_metric_lookup,
    clean_X_for_embedding,
    get_perts_col,
    plot_embedding_overlay,
)
from cyclops_utils.analysis.map_scores import (
    compute_auc_score,
...
from cyclops_utils.analysis.pca import fit_pca, n_pcs_for_threshold
from cyclops_utils.analysis.pca_sweep_plots import (
    plot_channel_peaks_bar,
    plot_metric_map_bar,
    plot_pca_sweep,
    plot_sweep_curves_summary,
)
from cyclops_utils.data.positive_controls import (
    plot_positive_controls_grid,
)

from cyclops_model.post_process.combination.pca_optimization.parser import (
    _build_parser,
)
from cyclops_model.post_process.combination.pca_optimization.slurm import (
...
from cyclops_model.post_process.combination.pca_optimization.sweep_core import (
    _init_sweep_logger,
...
from cyclops_model.post_process.combination.pca_optimization.aggregation import (
...
from cyclops_model.post_process.combination.pca_optimization.embeddings import (
    _compute_and_plot_embeddings,
    _score_consistency,
    _score_distinctiveness,
    _score_ebi_plus,
)
from cyclops_model.post_process.combination.pca_optimization.phase1 import (
    pca_sweep_pooled_signal,
)
from cyclops_model.post_process.combination.pca_optimization.phase2 import (
    _save_pc_marker_contributions,
    aggregate_channels,
    apply_second_pass_pca,
)
from cyclops_model.post_process.combination.pca_optimization.handlers import (
    _handle_external,
    _handle_second_pca,
)
