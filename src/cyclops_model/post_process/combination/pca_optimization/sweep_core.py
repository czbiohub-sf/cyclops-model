...
from cyclops_utils.analysis.pca import n_pcs_for_threshold
from cyclops_utils.analysis.pca_sweep_plots import plot_pca_sweep
...
def _init_sweep_logger():
    ...
    return logging.getLogger("cyclops_model.post_process.combination.pca_optimization")
