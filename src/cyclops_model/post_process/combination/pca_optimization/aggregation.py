...
def _score_single_reporter_metrics(
    ...
    """
    from cyclops_model.post_process.combination.pca_optimization import CHAD_ANNOTATION_PATH
    import math
...
def _annotate_genes_from_panel(adata_gene: ad.AnnData, _logger) -> None:
    ...
    """
    from cyclops_model.post_process.combination.pca_optimization import GENE_PANEL_PATH
