...
from cyclops_model.features.anndata_utils import aggregate_to_level
from cyclops_utils.analysis.embedding_plots import build_metric_lookup
from cyclops_utils.analysis.map_scores import plot_map_scatter
...
def _lazy_globals():
    ...
    from cyclops_model.post_process.combination.pca_optimization import (
