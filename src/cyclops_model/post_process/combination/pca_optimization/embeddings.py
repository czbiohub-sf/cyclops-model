...
from cyclops_model.features.anndata_utils import split_ntc_for_embedding
...
from cyclops_utils.data.positive_controls import plot_positive_controls_grid
...
def _score_distinctiveness(
    ...
    if activity_map is None:
        return None, 0.0
    try:
        from cyclops_utils.analysis.map_scores import phenotypic_distinctivness
...
def _score_ebi_plus(
    ...
    if activity_map is None:
        return None, 0.0
    try:
        from cyclops_utils.analysis.map_scores import phenotypic_ebi_plus
