...
from cyclops_model.data import data_loader
from cyclops_model.data.data_loader import CellProfileDataset
from cyclops_model.data.paths import OpsPaths
...
def _read_well_labels(args):
    ...
    exp_name, well = args
    # See note in cyclops_model.data.data_loader.OpsDataManager.get_labels: the
    ...
    from cyclops_model.data.labels import filter_small_bboxes
        ...
        for mk_name, mk_key in mask_configs:
            ...
            for ch_name, ch_idx in channels:
                ...
                if granularity_fcn is not None and _use_gpu_gran:
                    ...
                    from cyclops_model.models.cellprofiler.gpu_granularity import (
...
def extract_cp_features_parallel(
    ...
    from cyclops_model.models.cellprofiler.gpu_worker import (
        start_gpu_workers,
        stop_gpu_workers,
    )
