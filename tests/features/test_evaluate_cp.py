...
from cyclops_model.features.evaluate_cp import NONFEATURE_COLUMNS, create_adata_object
...
def processed_cp_adata(mock_cp_csv_path):
    ...
    with patch("cyclops_utils.data.feature_metadata.FeatureMetadata") as mock_fm:
