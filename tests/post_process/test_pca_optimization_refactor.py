...
def test_module_imports():
    ...
    from cyclops_model.post_process.combination import pca_optimization  # noqa: F401


def test_public_surface_present():
    """Pin the public entry points the rest of the codebase imports."""
    from cyclops_model.post_process.combination import pca_optimization as mod
...
def test_cli_help_subprocess():
    ...
    result = subprocess.run(
        [
            sys.executable,
            "-m",
            "cyclops_model.post_process.combination.pca_optimization",
            "--help",
        ],
        capture_output=True,
        text=True,
